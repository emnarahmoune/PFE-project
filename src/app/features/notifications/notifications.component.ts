...
export class NotificationsComponent implements OnInit, OnDestroy {
  mode: NotificationMode = 'EMPLOYE_NOTIFICATIONS';
  ...
  /**
   * Important :
   * Empêche une notification supprimée localement de revenir
   * si le service réémet une ancienne liste.
   */
